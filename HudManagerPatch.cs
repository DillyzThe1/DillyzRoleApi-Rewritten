        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            foreach (PlayerControl player in PlayerControl.AllPlayerControls)
            {
                ...
                if ((player.PlayerId == PlayerControl.LocalPlayer.PlayerId) ||  // If you're the player.
                    ...
                    HudManagerPatch.displayColor(__instance, player, theRole);

            }
        }

        public static void displayColor(HudManager __instance, PlayerControl player, CustomRole curRole)
        {
            ...
            string hex = DillyzUtil.colorToHex(curRole.roleColor);
